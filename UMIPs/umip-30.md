...
- Quote Currency: USDC
- Data Sources: {Uniswap V2: FRAX/USDC} for FRAX, {Uniswap V2: ESD/USDC} for ESD, {Uniswap v2: BAC/DAI} for BAC, {Bitfinex: UST/USD, Kraken: USDT/USD} for USDT, {Kraken: USDC/USD, Bitstamp: USDC/USD} for USDC, {Coinbase: ETH/USD, Bitfinex: ETH/USD} for ETH
